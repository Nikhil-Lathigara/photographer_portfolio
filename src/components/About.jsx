    ...
    >
      ...
      <div data-aos="fade-left" data-aos-duration="1000" data-aos-delay="100">
        ...
        <h2 className="font-fd text-[clamp(34px,4.5vw,68px)] font-light leading-none tracking-tight mb-7">
          Calm direction,
          <br />
          <em className="italic text-gold block">honest frames</em>
        </h2>

        <div className="text-[19px] font-light leading-[1.8] text-cream mt-7 space-y-4.5">
          <p>
            I am Arielle Voss, a photographer based in Mumbai creating wedding,
            portrait, event, fashion, and brand imagery with a warm cinematic eye.
            My work is guided by natural emotion, thoughtful composition, and light
            that feels alive.
          </p>
          <p>
            From quiet portrait sessions to full wedding weekends, I keep the
            experience easy, intentional, and human so you can be present while I
